...
const showDossier = (clients) => {
    clients.forEach((item) =>{
        const cardBox = document.createElement('div');
        cardBox.className = 'card';

        const clientName = document.createElement('h1');
        clientName.innerText = item.name;

        const clientUsername = document.createElement('h2');
        clientUsername.innerText = item.username;

        const clientEmail = document.createElement('p');
        clientEmail.innerText = 'email: ' + item.email;

        const clientAddress = document.createElement('h4');
        clientAddress.innerText = 'Address:';

        const clientAddressStreet = document.createElement('p');
        clientAddressStreet.innerText = '- ' + item.address.street + '  str.';

        const clientAddressCity = document.createElement('p');
        clientAddressCity.innerText = '- ' + item.address.city + '  city';

        const clientPhone = document.createElement('p');
        clientPhone.innerText = 'phone: ' + item.phone;
